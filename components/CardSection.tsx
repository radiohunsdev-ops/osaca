    ...
    >
      <div className="absolute left-0 top-0 w-full h-full pointer-events-none">
        <div className="absolute -left-26 top-0 w-full">
          <BroadcastIcon
            className="block w-[50%] h-[6vw]"
            color={audio.textColor}
          />
        </div>
      </div>
      ...
      <div className="relative z-10 text-center">
        {audio.date && (
          <p className="text-[14px] sm:text-[16px] mb-2">{audio.date}</p>
        )}
        <h3 className="text-[18px] sm:text-[22px] mb-4 sm:mb-6">
          {audio.title}
        </h3>
    ...
    >
      ...
      >
        ...
        {audioUrl ? (
          ...
          <Link
            href={card.link || `/journal/${card.slug}`}
